    ...
    stages {
        stage('Build Test Deploy') {
            ...
            stages{
                ...
                stage('Test') {
                    steps {
                        sh 'podman run -it --rm localhost/$IMAGE_NAME python -c "import cython; import mlconjug3; import ipdb; from cube.api import Cube; import jsonschema; from karel_robot.run import *; import spacy; import ipympl; import parselmouth; import matplotlib.pyplot as plt; import numpy as np; import mplcursors; import pytest; import tweepy; import gensim ; import morfessor ; import arpa; from linguistics import Document"'
